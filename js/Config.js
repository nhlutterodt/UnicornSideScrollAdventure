...
export const Config = {
    ...
    PATTERN_COOLDOWN_FALLBACK: 1000,
    CLOUD_SPAWN_INTERVAL: 2.5,
    PARTICLE_TRAIL_INTERVAL: 0.05,

    // Platforms
    PLATFORM_PLACEMENT_MODE: 'probabilistic', 
    PLATFORM_PROBABILITY: 0.3,
    CRUMBLING_PLATFORM_PROBABILITY: 0.15,
    CRUMBLING_PLATFORM_DELAY: 0.4,
    JUMP_PAD_ON_PLATFORM_PROBABILITY: 0.10,
